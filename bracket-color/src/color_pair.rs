...
mod tests {
    ...
    fn make_rgb_pair() {
        ...
        assert!(cp.fg.r < f32::EPSILON);
        assert!(cp.fg.g < f32::EPSILON);
        assert!(cp.fg.b < f32::EPSILON);
        assert!((cp.fg.a - 1.0).abs() < f32::EPSILON);
        assert!(cp.bg.r < f32::EPSILON);
        assert!(cp.bg.g < f32::EPSILON);
        assert!(cp.bg.b < f32::EPSILON);
        assert!((cp.bg.a - 1.0).abs() < f32::EPSILON);
    }
    ...
    fn make_rgba_pair() {
        ...
        assert!(cp.fg.g < f32::EPSILON);
        assert!(cp.fg.b < f32::EPSILON);
        assert!(cp.fg.a < f32::EPSILON);
        assert!(cp.bg.r < f32::EPSILON);
        assert!(cp.bg.g < f32::EPSILON);
        assert!(cp.bg.b < f32::EPSILON);
        assert!(cp.bg.a < f32::EPSILON);
    }
}
